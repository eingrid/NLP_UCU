...
model = AutoModelForSequenceClassification.from_pretrained(
    # MODEL,
    "emotion-roberta/checkpoint-1320",
...
# trainer.train()
# ckpt = torch.load("/home/nazara/UCU/NLP/ASSIGNMENT1/emotion-roberta/checkpoint-1320/model.safetensors", map_location=device, weights_only=False)
...
# ============================================================
# 8. Classification Report (detailed) - Standard argmax
# ============================================================
...
print("\n" + "="*60)
print("CLASSIFICATION REPORT (Standard argmax):")
print("="*60)
